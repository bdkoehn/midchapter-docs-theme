    ...
    "div",
    {
      ...
      children: [
        hasHeadings && /* @__PURE__ */ jsxs19(Fragment11, { children: [
          /* @__PURE__ */ jsx28("p", { className: "nx-font-caps nx-mb-4 nx-font-semibold nx-tracking-tight", children: renderComponent(config.toc.title) }),
        ...
        hasMetaInfo && /* @__PURE__ */ jsxs19(
          ...
          {
            className: cn18(
              hasHeadings && "nx-mt-8 nx-border-t",
              //'nx-bg-white',
...
var InnerLayout = ({
  ...
  return (
    ...
    /* @__PURE__ */ jsxs22("div", { dir: direction, children: [
      ...
      /* @__PURE__ */ jsx32("div", { className: "grainy nx-fixed nx--bottom-0 nx--left-0 nx--z-10 nx-h-full nx-w-full nx-opacity-10 dark:nx-opacity-5 sm:nx--bottom-0 sm:nx--left-0" })
    ] })
  );
};
function Layout(_a) {
